...
export const TRANSLATIONS: Record<Language, Translations> = {
  en: {
    ...
    calcTitle: 'Student Eligibility & Price Calculator',
    calcSubtitle: 'Enter student Date of Birth to determine age group, courses, fees, discounts, and PT requirements instantly.',
  ...
  ar: {
    ...
    calcTitle: 'حاسبة أهلية وأسعار كورسات الطلاب',
    calcSubtitle: 'اكتب تاريخ ميلاد الطالب لحساب السن بالضبط، والمرحلة الدراسية، والامتحان المطلوب، والسعر والخصومات فوراً وأنت مع العميل على الخط.',
    resetBtn: 'إعادة ضبط الحاسبة',
